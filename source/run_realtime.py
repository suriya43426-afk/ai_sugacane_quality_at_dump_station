...
# Added genpts and larger reorder_queue_size for HEVC/H.265 stability.
os.environ["OPENCV_FFMPEG_CAPTURE_OPTIONS"] = "rtsp_transport;tcp|flags;low_delay|max_delay;500000|fflags;genpts|reorder_queue_size;100"
